        ...
        renderDayView() {
            ...
            for (var i = 0; i < 6; i++) {
                ...
                for (var j = 0; j < 7; j++) {
                    ...
                    if (dayViewDays[i][j].isOld) td.addClass("old");
                    if (dayViewDays[i][j].isActive) td.addClass("active");
                    if (dayViewDays[i][j].isToday) td.addClass("today");
                    if (dayViewDays[i][j].isNew) td.addClass("new");
                    if (dayViewDays[i][j].isDisabled) td.addClass("disabled");

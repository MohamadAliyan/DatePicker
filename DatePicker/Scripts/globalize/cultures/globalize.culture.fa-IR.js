...
(function (window, undefined) {
    ...
    Globalize.addCultureInfo("fa-IR", "default", {
        ...
        numericSymbols: ["هزار", "میلیون", "میلیارد", "هزار میلیارد", "بیلیارد", "تریلیون"],
        calendars: {
            standard: {
                name: "Persian",
                firstDay: 6,
                ...
                convert: {
                    ...
                    toGregorian: function (hyear, hmonth, hday) {
                        ...
                        return (new Date(Date.UTC(gDate[0], gDate[1] - 1, gDate[2])));
                    },
                    ...
                    isLeapYear: function (year) {
                        year = Math.abs(this.fix(year));
                        return ((year * 8 + 29) % 33) < 8;
                    },
                    getDaysInMonth: function (year) {
                        if (!year) year = this.fromGregorian(new Date())[0];
                        if (this.isLeapYear(year))
                            return [31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 30];
                        else
